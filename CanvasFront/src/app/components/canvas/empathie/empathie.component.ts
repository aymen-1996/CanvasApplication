...
@Component({
  ...
  styleUrls: ['./empathie.component.css']
})
export class EmpathieComponent implements OnInit {
...
calculatePositionBlock2(index: number): { top: string, left: string } {
  ...
  if (index === 0) {
    calculatedTop = '43.3em';
    calculatedLeft = '101em';
  } else if (index === 1) {
    calculatedTop = '48.3em';
    calculatedLeft = '113em';
  } else if (index === 2) {
    calculatedTop = '38.3em';
    calculatedLeft = '113em';
  } else {
    calculatedTop = '0%';
    calculatedLeft = '0em';
...
calculatePositionBlock3(index: number): { top: string, left: string } {
  ...
  if (index === 0) {
    ...
    calculatedTop = '31em';
    calculatedLeft = '100.3em';
  } else if (index === 2) {
    calculatedTop = '31em';
    calculatedLeft = '74.3em';
  } else {
    calculatedTop = '0%';
    calculatedLeft = '0em';
  }
...
calculatePositionBlock7(index: number): { top: string, left: string } {
  let calculatedTop: string;
  let calculatedLeft: string;

  if (index === 0) {
    calculatedTop = '51.5em';
    calculatedLeft = '87em';
  } else if (index === 1) {
    calculatedTop = '56.9em';
    calculatedLeft = '100.3em';
    } else if (index === 2) {
    calculatedTop = '56.9em';
    calculatedLeft = '74.3em';
...
calculatePositionBlock4(index: number): { top: string, left: string } {
  ...
  if (index === 0) {
    calculatedTop = '40.3em';
    calculatedLeft = '54.2em';
  } else if (index === 1) {
    calculatedTop = '45.3em';
    calculatedLeft = '42.2em';
  } else if (index === 2) {
    calculatedTop = '35.3em';
    calculatedLeft = '42.2em';
  } else {
    calculatedTop = '0%';
    calculatedLeft = '0em';
...
calculatePositionBlock6(index: number): { top: string, left: string } {
  let calculatedTop: string;
  let calculatedLeft: string;

  if (index === 0) {
    calculatedTop = '32.8em';
    calculatedLeft = '68em';
  } else if (index === 1) {
    calculatedTop = '27.8em';
    calculatedLeft = '81.3em';
  } else if (index === 2) {
    calculatedTop = '27.8em';
    calculatedLeft = '55.3em';
  } else {
    calculatedTop = '0%';
    calculatedLeft = '0em';
  }
...
calculatePositionBlock8(index: number): { top: string, left: string } {
  let calculatedTop: string;
  let calculatedLeft: string;
    ...
    (data) => {
      if (data && Array.isArray(data.Canvas)) {
        ...
        if (bmcCanvas) {
          ...
          console.log("ID du canvas Empathy Map Canvas  getBlocksByCanvasId:", this.canvasId);
    ...
    (data) => {
      if (data && Array.isArray(data.Canvas)) {
        ...
        if (bmcCanvas) {
          ...
          console.error('Canvas Empathy Map Canvas  non trouvé');
        }
      } else {
